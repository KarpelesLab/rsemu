//! A 6845-derived CRTC and its character generator.
//!
...
pub const REGISTER_WINDOW_LEN: u64 = 32;
...
pub static CLASS: DeviceClass = DeviceClass {
    name: CLASS_NAME,
    version: 1,
    summary: "MC6845 CRTC with a text-mode character generator",
    properties: &[],
