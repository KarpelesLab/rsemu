...
//! | [`mac`] | `dev-mac` | the Macintosh board: the ROM overlay at address zero, a 6522 VIA, the video circuit that reads main memory, and a Z8530 |
...
//! | `ata::atapi` | `dev-ata-atapi` | an ATAPI CD-ROM: the packet interface and the MMC subset a boot needs |
...
#[cfg_attr(docsrs, doc(cfg(feature = "dev-ncr53c710")))]
pub mod ncr53c710;
