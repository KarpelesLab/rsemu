...
//!
//! Not yet: a native window or a native sound card — both need either a GUI/audio
//! dependency the policy forbids or a seventh `unsafe` subsystem the ceiling
//! forbids; the IR and JIT; and the rest of the host layer (VNC, an interactive
//! monitor console).
//!
//! # `no_std`
//!
